...
function Signup() {
  ...
  const create = async (data) => {
    ...
    try {
      ...
      if (userData) {
        ...
        if (userData) {
          await appwriteServices.createStat(userData.$id)
  ...
  return (
    <div className='flex items-center justify-center'>
      <div
        className={`mx-auto w-full max-w-lg bg-gray-100 rounded-xl p-10 border border-black/10 dark:bg-slate-800 dark:text-white`}
      >
